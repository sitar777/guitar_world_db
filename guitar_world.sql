...
('The Jimi Hendrix Experience'	,f,	'London'	,f	),
('Led Zeppelin',	        ,f,	'London'	,f	),
('The Youngbirds',	        ,t,	'London'	,f	),
('Van Halen',	                ,t,	'Pasadena'	,t	),
('Cream',	                ,f,	'London'	,f	),
('Eric Clapton',	        ,t,	'Surrey'	,t	),
('Guns`N Roses',	        ,t,	'Los-Angeles'	,f	),
('Slash`s Snakepit',	        ,f,	'Los-Angeles'	,t	),
('Double Trouble',	        ,t,	'Austin'	,f	),
('Pink Floyd',	                ,f,	'London'	,f	),
('Metallica',	                ,t,	'Los-Angeles'	,f	),
('Exodus',	                ,t, 	'San-Francisco'	,f	),
('AC/DC',	                ,t,	'Sydney'	,f	),
('Pantera',	                ,f,	'Arlington'	,f	),
('Damageplan',	                ,f,	'Dallas'	,t	),
('Ozzy Osbourne',	        ,t,	'Birmingham'	,t	),
('Quet Riot',	                ,t,	'Los-Angeles'	,f	),
('Smile',	                ,f,	'London'	,f	),
('Queen', 	                ,t,	'London'	,f	),
('Chuck Berry',	                ,f,	'Wentzwille'	,t	),
('Whitesnake',	                ,f,	'Middlesbrough'	,f	),
('G3',	                        ,f,	                ,t	),
('Santana',	                ,t,	'Jalisco'	,t	),
('The Beatles',	                ,f,	'Liverpool'	,f	),
('Judas Priest',	        ,t,	'Birmingham'	,f	),
('B.B.King',	                ,f,	'Las-Vegas'	,t	),
('David Bowie',	                ,f,	'Manhattan'	,t	),
('Elvis Presley',	        ,f,	'Tupelo'	,t	),
('Ornette Coleman',	        ,f,	'Manhattan'	,t	),
('Bon Jovi',	                ,t,	'New-Jersey'	,f	),
('Steve Vai',	                ,t,	'New-York'	,t	);
...
('Jimmy'	,'Page'          ,1944-01-09	,	   ,     ,2,	,2	),
('Edward'	,'van Halen'	 ,1955-01-26	,	   ,     ,1,	,3	),
('Eric'         ,'Clapton'	 ,1945-03-30	,	   ,     ,2,	,3	),
('Slash'	,                ,1965-07-23	,	   ,     ,1,	,4	),
('Stevie'	,'Vaughan'	 ,1954-10-03	,1990-08-27,	 ,1,	,5      ),
('David' 	,'Guilmour'	 ,1946-03-06	,	   ,     ,2,	,6	),
('Kirk'	        ,'Hammett'       ,1962-11-18	,	   ,     ,1,	,3	),
('Angus'	,'Young'         ,1955-03-31	,	   ,     ,3,	,6	),
('Darell'	,'Dimebag'       ,1966-08-20	,2004-11-08,	 ,1,	,7	),
('Randy'        ,'Rhoads'        ,1965-11-06	,1982-03-19,	 ,1,	,5	),
('Brian'	,'May'           ,1947-07-19	,	   ,     ,2,	,8	),
('Chuck'        ,'Berry'         ,1926-10-18	,2017-03-18,	 ,1,	,9	),
('Steve'        ,'Vai'           ,1960-07-06	,	   ,     ,1,	,10	),
('Carlos'	,'Santana'       ,1947-07-20	,	   ,     ,1,	,11	);
